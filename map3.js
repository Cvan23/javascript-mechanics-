// More practice w/ .map method
// Will take the original array and return a new array of the same length
...
const fullNames = inventors.map(inventor => inventor.first + ' ' + inventor.last);
                                        ...
                                        // *4 ↓
const fllNms = inventors.map(inventor => `${inventor.first} ${inventor.last}`);
